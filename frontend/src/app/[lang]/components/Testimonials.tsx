  ...
  return (
    <div className="flex flex-col items-center mx-12 lg:mx-0">
      ...
      <div className="relative text-center">
        ...
        <p className="px-6 py-1 text-lightBlueNew text-lg italic">{text}</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
          fill="currentColor"
      ...
      <span className="w-12 h-1 my-2 rounded-lg bg-Gold"></span>
      <p className="text-lightBlueNew">{authorName}</p>
    </div>
  );
}
...
export default function Testimonials({ data }: TestimonialsProps) {
  return (
    <section className=" bg-lightBackground  py-24">
